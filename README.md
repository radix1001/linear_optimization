...
10. [bus_assignment_ampl_python.ipynb](./bus_assignment_ampl_python.ipynb)
...
11. [control_recycling_alloy_pure_python.ipynb](./control_recycling_alloy_pure_python.ipynb)
   Pure Python notebook for the course control on alloy blending, solved with five exact techniques and explicit verification of the optimal mix.
...
- Technology production problem (book `2.2`) and its split production/assembly variant
